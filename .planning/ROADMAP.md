...
- [x] 03-01-PLAN.md — Write the fail-first validator, resolver, and exact bootstrap test contract.

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 03-02-PLAN.md — Implement the validated catalogue and canonical bank-aware resolver.

**Wave 3** *(blocked on Wave 2 completion)*

- [ ] 03-03-PLAN.md — Close sparse-array and hidden-own-key validation gaps with adversarial regression coverage.
...
| 3. Catalogue Mechanism & Bootstrap | v2.0 | 2/3 | In Progress | - |
